...
(function () {
  ...
  var option = {
    ...
    xAxis: [{
      type: 'category',
      data: [ "<100000", "100000-500000", "500000-1000000","个人现金支付>=1000000",],
      axisTick: {
        alignWithLabel: true
      },
      // 修改刻度标签，相关样式
...
(function () {
  ...
  var option = {
    ...
    series: [{
        ...
        data: [44647,48724,51478,55587,58850]
      }
    ]
  };
